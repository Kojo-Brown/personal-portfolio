...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: "backend",
    description:
      "Full-stack animal service application with comprehensive API architecture",
    longDescription:
      "Built a complete animal service application featuring RESTful API architecture, authentication systems, and comprehensive security measures.",
    image: "/api/placeholder/600/400",
    ...
    githubUrl: "https://github.com/Kojo-Brown/animal-service-api",
    status: "completed",
    year: "2025",
  },
  {
    ...
    liveUrl: "https://environmental-learning-platform.vercel.app",
    status: "completed",
    year: "2024",
    githubUrl:
  ...
  },
  {
    ...
    githubUrl: "https://github.com/Kojo-Brown/realtime-chat-app",
    status: "completed",
    year: "2023",
  },
  {
    ...
    longDescription:
      "Built a sophisticated analytics dashboard for e-commerce businesses featuring sales tracking, customer analytics, inventory management, and predictive insights. The dashboard provides real-time data visualization and actionable business intelligence.",
    image: "/api/placeholder/600/400",
    technologies: ["React.js", "Chart.js", "Node.js", "PostgreSQL", "Docker"],
    features: [
    ...
    githubUrl: "https://github.com/Kojo-Brown/ecommerce-dashboard",
    status: "completed",
    year: "2024",
  },
];
